...
@app.route(rule='/first_exam_seventh_grade', methods=["GET", "POST"])
def first_exam_seventh_grade_page():
    if request.method == 'POST':
        student_num = request.form.get('stud_num')
        student_name = request.form.get('stud_name')
        student_class = request.form.get('stud_class')
        q1_choke_area = request.form.get('choke_area')
        q1_incision = request.form.get('incision')
        q1_view = request.form.get('view')
        q2_objective_crit = request.form.getlist('objective_crit')
        q2_subjective_crit = request.form.getlist('subjective_crit')
        q3_converters = request.form.get('converters')
        q3_devices = request.form.get('devices')
        q4_making_holes = request.form.get('making_holes')
        q5_mechanical = request.form.getlist('mechanical')
        q5_technical = request.form.getlist('technical')
        q6_measurement = request.form.getlist('measurement')
        q6_cutting = request.form.getlist('cutting')
        q7_drill_bit = request.form.get('drill_bit')
        q7_soldering_iron = request.form.get('soldering_iron')
        q7_saw = request.form.get('saw')
        q8_water_magnitude = request.form.get('water_magnitude')
        q8_water_unit_of_measure = request.form.get('water_unit_of_measure')
        q8_electricity_magnitude = request.form.get('electricity_magnitude')
        q8_electricity_unit_of_measure = request.form.get('electricity_unit_of_measure')
        q8_thermo_magnitude = request.form.get('thermo_magnitude')
        q8_thermo_unit_of_measure = request.form.get('thermo_unit_of_measure')
        q9_signal_installations = request.form.getlist('signal_installations')
        q10_expense = request.form.get('expense')
        q10_family_budget = request.form.get('family_budget')
        q10_profit = request.form.get('profit')
        q11_entrepreneurship = request.form.getlist('entrepreneurship')
        q12_soil = request.form.get('soil')
